...
def load_COIL_100_fromFile( ):
    data = np.load('xtrainCOIL_100.npy', allow_pickle=True)
...
if __name__ == "__main__":
    ...
    (x_train, y_train, x_val), (x_test, y_test, y_val) = load_COIL_100_fromFile()
    print("COIL shapes: x_train: ", x_train.shape, "x_test: ", x_test.shape, "x_val: ", x_val.shape)
